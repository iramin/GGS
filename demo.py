...
if __name__ == '__main__':
    ...
    data = mat['data']
    # csv EEGRat_10_1000.txt
    # print(data.shape[1])
    # data = read_csv("Data/EEGRat_10_1000.txt")
    data1 = read_csv("metrics/ModelwaleElemXflowMixFrac3.5mVersion1RUN1Interval1000000/meminfo/Dirty.txt")
    # data1 = read_csv(
    #     "metrics/ModelwaleElemXflowMixFrac3.5mVersion1RUN1Interval1000000/shm_sampler/MPI_Reduce.calls.0.rate.txt")
    data2 = read_csv("metrics/ModelwaleElemXflowMixFrac3.5mVersion1RUN1Interval1000000/shm_sampler/MPI_Issend.calls.0.rate.txt")
    data3 = read_csv(
        "metrics/ModelwaleElemXflowMixFrac3.5mVersion1RUN1Interval1000000/shm_sampler/MPI_Scatter.calls.7.rate.txt")
    data4 = read_csv(
        "metrics/ModelwaleElemXflowMixFrac3.5mVersion1RUN1Interval1000000/procnfs/write.rate.txt")
    # data.append(data)
    data = data1
    data['a'] = data2
    data['b'] = data4
    ...
    plot_motifs(mat_pro_2, dimensionality=data.shape[1])
